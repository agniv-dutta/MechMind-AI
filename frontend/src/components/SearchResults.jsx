        ...
        {results && !loading && !error && (
          <div className="space-y-4">
            ...
            {results.results.map((r, i) => {
              ...
              return (
                <div key={r.chunk_id || i} className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xs space-y-3">
                  ...
                  <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 text-xs text-slate-700 dark:text-slate-300 leading-relaxed border border-slate-200/60 dark:border-slate-800 line-clamp-3">
                    {r.content}
                  </div>
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl text-xs font-bold text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors flex items-center space-x-1.5"
                    >
