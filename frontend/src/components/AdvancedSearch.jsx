            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="space-y-1">
                ...
                <div className="relative">
                  <select value={equipmentClass} onChange={(e) => setEquipmentClass(e.target.value)} className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-semibold text-slate-800 dark:text-slate-200 appearance-none focus:outline-none">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <select value={docType} onChange={(e) => setDocType(e.target.value)} className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-semibold text-slate-800 dark:text-slate-200 appearance-none focus:outline-none">
      ...
      {results && !loading && !error && (
        <div className="space-y-4">
          ...
          {filteredResults.map((r, i) => {
            ...
            return (
              <div key={r.chunk_id || i} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-slate-300 dark:hover:border-slate-700 shadow-2xs transition-all space-y-3">
                ...
                <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 text-xs text-slate-700 dark:text-slate-300 leading-relaxed border border-slate-200/60 dark:border-slate-800 line-clamp-4">
                  {r.content}
                </div>
